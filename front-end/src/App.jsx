...
const rel_levels = {
  0: { label: "fails to meet", color: "secondary" },
  1: { label: "slightly meets", color: "info" },
  2: { label: "moderately meets", color: "primary" },
  3: { label: "highly meets", color: "warning" },
  4: { label: "fully meets", color: "success" },
};
